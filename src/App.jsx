        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-8 overflow-hidden w-full">
          <div className="max-w-md w-full bg-white rounded-[60px] p-16 shadow-2xl border-t-[16px] border-yellow-400 animate-in fade-in zoom-in duration-500">
            ...
            <form onSubmit={handleLogin} className="space-y-6 mt-12">
              ...
              <button type="submit" className="w-full bg-black text-white py-6 rounded-2xl font-black uppercase hover:bg-yellow-400 hover:text-black transition-all active:scale-95 shadow-xl">Verify & Sign In</button>
            </form>
            <button onClick={goHome} className="w-full mt-10 text-gray-400 font-black text-[10px] tracking-widest uppercase hover:text-black transition-colors">← Back to Site</button>
          </div>
        </div>
      );
    }
